...
*/
import { tablaDeFunciones, tablaDeVariables, errorEncontrado } from "./analizadorSintactico.js";

let sentenciaToken;

export function mainSemantico() {
                ...
                lineasDeSentencia.forEach((sentencia) => {
                    ...
                    if (
                        ...
                        errorEncontrado =
                            ...
                            "La variable " +
                            sentencia.token +
                            " no esta declarada en la clase var. Error en la linea " +
                            sentencia.linea +
                            " \n";
                    }
